...
namespace CoinJar.Models
{
    ...
    public abstract class Coin<T> where T : Currency
    {
        ...
        public T Price { get { return _price; } }

        // first constructor , not initialize coinName as parameter
        public Coin(FluidOunces volume, T price)
        {
            _volume = volume;
            _price = price;
        }
        ...
        public Coin(string coinName, FluidOunces volume, T price)
        {
            _coinName = coinName;
            _volume = volume;
            _price = price;
    ...
    {
        public USCoin(string coinName, float volume, float price) : base (coinName, new FluidOunces(volume) , new USCurrency(price)) {}
    }
